...
const Safari = () => {
    return (
        <div id='window-header' className='safari-window flex flex-col h-full'>
            <div className="flex align-center justify-around w-full items-center border-b border-gray-300">
